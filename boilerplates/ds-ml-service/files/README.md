...
### Docker ###
Each service has their own *Dockerfile*, under *docker-prediction* *docker-training* respectively, which can be changed according to your requirements on operating system dependencies.
...
This can easily achieved, either by using an IDE that supports that (e.g. PyCharm) or by doing manually in the docker container.
...
Setup the right values for the environment variables in *docker-compose.yml* file wherever there is a difinition like *THIS_PARAMETER_SHOULD_BE_NOT_COMMITED*
```
