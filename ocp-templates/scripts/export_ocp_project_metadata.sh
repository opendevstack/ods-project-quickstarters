...
do
	...
	oc get --export -o yaml secret,rolebindings,sa --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/project.yml
...
#
    ...
    oc get configmap --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${configmap_file}
#
    ...
    do
		...
		oc get --export -o yaml configmap ${cmap_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/config/configmap_${cmap_name}.yml
...
#
    ...
    oc get sa --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${sa_file}
#
    ...
    do
        ...
        sa_config=($line)
        sa_name=${sa_config[0]}
		oc get --export -o yaml sa ${sa_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/sa/sa_${sa_name}.yml
...
#
    ...
    oc get template --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${template_file}
#
    ...
    do
		...
		oc get --export -o yaml template ${template_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/template/template_${template_name}.yml
...
#
    ...
    oc get bc --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${build_file}
#
    ...
    do
        ...
        bc_config=($line)
        bc_name=${bc_config[0]}
		oc get --export -o yaml bc ${bc_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/bc/bc_${bc_name}.yml
...
#
    ...
    oc get dc --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${deploy_file}
#
    ...
    do
        ...
        dc_config=($line)
        dc_name=${dc_config[0]}
		oc get --export -o yaml dc ${dc_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/dc/dc_${dc_name}.yml
...
#
    ...
    oc get service --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${service_file}
#
    ...
    do
		...
		oc get --export -o yaml svc ${svc_name} --namespace $curr_ocp_namespace > ${ocp_proj_namespace_suffix}/service/svc_${svc_name}.yml
...
#
    ...
    oc get pvc --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1,4,5 > ${tsv_file}
#
...
#
    ...
    oc get is --export=true --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1 > ${is_file}
#
...
#
	...
	oc get route --no-headers --namespace $curr_ocp_namespace |  sed 's/  */ /g' | cut -d ' ' -f1,2,3,4,5,6,7 >${route_file}
#
