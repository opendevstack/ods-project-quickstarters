...
sed -i.final -e "s|value: NEXUS_USERNAME|value: $NEXUS_USERNAME|g" ../templates/cd-jenkins-persistent.yml
sed -i.final -e "s|value: NEXUS_PASSWORD|value: $NEXUS_PASSWORD|g" ../templates/cd-jenkins-persistent.yml
